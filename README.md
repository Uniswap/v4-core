...
Uniswap V4 Core is licensed under the Business Source License 1.1 (`BUSL-1.1`), see [BUSL.LICENSE](https://github.com/Uniswap/v4-core/blob/main/LICENSE), and the MIT License (`MIT`), see [MIT.LICENSE] (PATH). Each file in Uniswap V4 Core states the applicable license type in the header.
