...
library Pool {
    ...
    function initialize(PoolState storage self, uint160 sqrtPriceX96, uint24 protocolFee, uint24 lpFee)
        internal
        returns (int24 tick)
    {
    ...
    function setProtocolFee(PoolState storage self, uint24 protocolFee) internal {
        self.checkPoolInitialized();
        self.slot0 = self.slot0.setProtocolFee(protocolFee);
    }

    /// @notice Only dynamic fee pools may update the lp fee.
    function setLPFee(PoolState storage self, uint24 lpFee) internal {
        self.checkPoolInitialized();
    ...
    function modifyLiquidity(PoolState storage self, ModifyLiquidityParams memory params)
        internal
    ...
    function donate(PoolState storage self, uint256 amount0, uint256 amount1) internal returns (BalanceDelta delta) {
    ...
    function checkPoolInitialized(PoolState storage self) internal view {
    ...
    function clearTick(PoolState storage self, int24 tick) internal {
