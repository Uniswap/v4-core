...
library SwapMath {
    uint24 internal constant MAX_FEE_PIPS = 1e6;
    ...
    function getSqrtRatioTarget(bool zeroForOne, uint160 sqrtPriceNextX96, uint160 sqrtPriceLimitX96)
        internal
        pure
        ...
        unchecked {
            ...
            if (exactIn) {
                ...
                if (amountRemainingLessFee >= amountIn) {
                    ...
                    sqrtRatioNextX96 =
                        SqrtPriceMath.getNextSqrtPriceFromInput(sqrtRatioCurrentX96, liquidity, amountIn, zeroForOne);
