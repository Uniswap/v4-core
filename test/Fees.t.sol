...
contract FeesTest is Test, Deployers, GasSnapshot {
    ...
    function testInitializeHookProtocolSwapFee(uint16 hookSwapFee, uint16 protocolSwapFee) public {
        ...
        feeController.setSwapFeeForPool(key0.toId(), protocolSwapFee);
    ...
    function testInitializeAllFees(
        ...
        feeController.setSwapFeeForPool(key2.toId(), protocolSwapFee);
        feeController.setWithdrawFeeForPool(key2.toId(), protocolWithdrawFee);
    ...
    function testProtocolFeeOnWithdrawalRemainsZeroIfNoHookWithdrawalFeeSet(
        ...
        feeController.setWithdrawFeeForPool(key0.toId(), protocolWithdrawFee);
        manager.setProtocolFees(key0);
        ...
        assertEq(manager.balanceOf(address(protocolFeeController), currency0), 0);
        assertEq(manager.balanceOf(address(protocolFeeController), currency1), 0);
    ...
    //     manager.setProtocolFeeController(IProtocolFeeController(feeController));

    //     feeController.setSwapFeeForPool(key0.toId(), newFee);
    //     vm.expectRevert(abi.encodeWithSelector(IFees.FeeDenominatorOutOfBounds.selector, newFee));
    //     manager.setProtocolFees(key0);

    //     feeController.setWithdrawFeeForPool(key0.toId(), newFee);
    //     vm.expectRevert(abi.encodeWithSelector(IFees.FeeDenominatorOutOfBounds.selector, newFee));
    //     manager.setProtocolFees(key0);
    // }
    ...
    function testHookWithdrawFeeProtocolWithdrawFee(uint16 hookWithdrawFee, uint16 protocolWithdrawFee) public {
        ...
        assertEq(manager.balanceOf(address(protocolFeeController), currency0), expectedProtocolAmount0);
        assertEq(manager.balanceOf(address(protocolFeeController), currency1), expectedProtocolAmount1);
    ...
    function testProtocolSwapFeeAndHookSwapFeeSameDirection() public {
        ...
        feeController.setSwapFeeForPool(key0.toId(), protocolFee);
        manager.setProtocolFees(key0);
        ...
        assertEq(manager.balanceOf(address(protocolFeeController), currency1), 3); // 10% of 30 is 3
    ...
    function testSwapWithProtocolFeeAllAndHookFeeAllButOnlySwapFlag() public {
        ...
        feeController.setWithdrawFeeForPool(key0.toId(), protocolFee); //
        manager.setProtocolFees(key0);
        ...
        assertEq(manager.balanceOf(address(protocolFeeController), currency1), 0); // No protocol fee was accrued on swap
        assertEq(manager.balanceOf(address(protocolFeeController), currency0), 0); // No protocol fee was accrued on swap
        ...
        assertEq(manager.balanceOf(address(protocolFeeController), currency1), 0); // No protocol fee was accrued on withdraw
        assertEq(manager.balanceOf(address(protocolFeeController), currency0), 0); // No protocol fee was accrued on withdraw
    ...
    function testCollectFees() public {
        ...
        manager.collectProtocolFees(address(feeController), currency1, 0);
        assertEq(currency1.balanceOf(address(feeController)), expectedProtocolFees);
