            ...
            uint160(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)
                & uint160(
                    ~Hooks.BEFORE_INITIALIZE_FLAG & ~Hooks.AFTER_INITIALIZE_FLAG & ~Hooks.BEFORE_MINT_FLAG
                        & ~Hooks.AFTER_MINT_FLAG & ~Hooks.BEFORE_BURN_FLAG & ~Hooks.AFTER_BURN_FLAG & ~Hooks.AFTER_SWAP_FLAG
    ...
    DynamicFeesTestHook dynamicFeesNoHook = DynamicFeesTestHook(
        address(
            uint160(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)
                & uint160(
                    ~Hooks.BEFORE_INITIALIZE_FLAG & ~Hooks.AFTER_INITIALIZE_FLAG & ~Hooks.BEFORE_MINT_FLAG
                        & ~Hooks.AFTER_MINT_FLAG & ~Hooks.BEFORE_BURN_FLAG & ~Hooks.AFTER_BURN_FLAG & ~Hooks.BEFORE_SWAP_FLAG
