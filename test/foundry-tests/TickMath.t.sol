...
contract TestTickMath is Test, GasSnapshot {
    // Wrapper contracts that expose the TickMath library. Useful for catching reverts.
    TickMathTest internal wrapper;
    TickMathReference internal refWrapper;

    function setUp() public {
        wrapper = new TickMathTest();
        refWrapper = new TickMathReference();
    }

    /// @notice Benchmark the gas cost of `getSqrtRatioAtTick`
    function testGasGetSqrtRatioAtTick() public {
        snapStart("TickMath.getSqrtRatioAtTick");
    ...
    function testRevertGetSqrtRatioAtTick() public {
    ...
    function testFuzzGetSqrtRatioAtTick(int24 tick) public {
        ...
        assertEq(sqrtPriceX96, refWrapper.getSqrtRatioAtTick(tick));
    }

    /// @notice Benchmark the gas cost of `getTickAtSqrtRatio`
    function testGasGetTickAtSqrtRatio() public {
        snapStart("TickMath.getTickAtSqrtRatio");
    ...
    function testRevertGetTickAtSqrtRatio() public {
...
/// @notice A reference implementation of TickMath
contract TickMathReference {
