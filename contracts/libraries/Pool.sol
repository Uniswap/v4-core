        ...
        returns (UQ128x128 feeGrowthInside0, UQ128x128 feeGrowthInside1)
    {
        ...
        unchecked {
            if (tickCurrent < tickLower) {
                feeGrowthInside0 = lower.feeGrowthOutside0.uncheckedSub(upper.feeGrowthOutside0);
                feeGrowthInside1 = lower.feeGrowthOutside1.uncheckedSub(upper.feeGrowthOutside1);
            } else if (tickCurrent >= tickUpper) {
                feeGrowthInside0 = upper.feeGrowthOutside0.uncheckedSub(lower.feeGrowthOutside0);
                feeGrowthInside1 = upper.feeGrowthOutside1.uncheckedSub(lower.feeGrowthOutside1);
            } else {
                feeGrowthInside0 =
                    (self.feeGrowthGlobal0.uncheckedSub(lower.feeGrowthOutside0)).uncheckedSub(upper.feeGrowthOutside0);
                feeGrowthInside1 =
                    (self.feeGrowthGlobal1.uncheckedSub(lower.feeGrowthOutside1)).uncheckedSub(upper.feeGrowthOutside1);
            }
        }
    }
