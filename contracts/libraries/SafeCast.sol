...
library SafeCast {
    ...
    /// @notice Cast a uint256 to a int248, revert on overflow
    /// @param y The uint256 to be casted
    /// @return z The casted integer, now type int248
    function toInt248(uint256 y) internal pure returns (int248 z) {
        require(y < 2**247);
        z = int248(int256(y));
    }
