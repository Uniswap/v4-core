...
library PoolGetters {
    ...
    bytes32 constant MASK_128 = bytes32(uint256((1 << 128) - 1));
    ...
    function getNetLiquidityAtTick(IPoolManager poolManager, bytes32 poolId, int24 tick) internal returns (int128) {
